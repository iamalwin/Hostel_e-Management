                ...
                <div class="content-wrapper p-4">
                    ...
                    <div class="grid-margin card p-5 stretch-card">
                        ...
                        if (isset($_POST['studentID'])) {
                            ...
                            $qry = mysqli_query($connect, "SELECT * FROM stud WHERE stud_id LIKE '%$searchID%'");
                        } else {
                        ...
                        <table class="table table-responsive-xl">
                            ...
                            ?>
                                <tr class="alert" role="alert">
                                    ...
                                    <td>
                                        <a style="text-decoration: none; " href="./fees_details.php?reg=<?php echo $row['reg']; ?>"><h6>View Fees</h6></a>
                                    </td>
                                    <td>
